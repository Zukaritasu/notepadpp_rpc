...
To create a custom rich presence you must create an application for discord, if you already have an application created you only need the ID and enter it in the text field in the "Custom Application id" options window... Now we need to upload the images in the application
